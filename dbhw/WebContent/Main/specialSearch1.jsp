...
<head>
<meta charset="EUC-KR">
<title>Special Search1 Result</title>
</head>
<%
	//1. Connection
	...
	String sql = 
			"SELECT DISTINCT product.name, product.productID, femaleSub.sum "
	...
	try {
		...
		out.print("<p>남자보다 여자가 많이 산 상품의 이름</p>");
